...
namespace BtsProjectSite.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Details()
        {
            ...
            var FirstName = identity.FindFirst(ClaimTypes.GivenName);
            accountDetails.ClaimsFirstName = FirstName == null ? "(none)" : FirstName.Value;

            // Get the surname, if present
            var LastName = identity.FindFirst(ClaimTypes.Surname);
            accountDetails.ClaimsLastName = LastName == null ? "(none)" : LastName.Value;
